...
class ProgressEntriesTable extends Table {
  ...
  IntColumn get consecutiveInactiveDays => integer().withDefault(const Constant(0))();
  ...
  IntColumn get totalSessionsSinceDisclaimer => integer().withDefault(const Constant(0))();
